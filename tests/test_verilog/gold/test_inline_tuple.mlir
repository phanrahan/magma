module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    ...
    hw.module @Main(%I_0_data: i5, %I_0_valid: i1, %I_1_data: i5, %I_1_valid: i1, %O_0_ready: i1, %O_1_ready: i1, %CLK: i1) -> (I_0_ready: i1, I_1_ready: i1, O_0_data: i5, O_0_valid: i1, O_1_data: i5, O_1_valid: i1) {
        %0, %1, %2, %3, %4, %5 = hw.instance "delay" @DelayUnit(INPUT_0_data: %I_1_data: i5, INPUT_0_valid: %I_1_valid: i1, INPUT_1_data: %I_0_data: i5, INPUT_1_valid: %I_0_valid: i1, OUTPUT_0_ready: %O_1_ready: i1, OUTPUT_1_ready: %O_0_ready: i1, CLK: %CLK: i1) -> (INPUT_0_ready: i1, INPUT_1_ready: i1, OUTPUT_0_data: i5, OUTPUT_0_valid: i1, OUTPUT_1_data: i5, OUTPUT_1_valid: i1)
        ...
        %7 = sv.xmr "delay", "inner_delay", "OUTPUT_0_valid" : !hw.inout<i1>
        %6 = sv.read_inout %7 : !hw.inout<i1>
        %9 = sv.xmr "delay", "inner_delay", "INPUT_1_ready" : !hw.inout<i1>
        %8 = sv.read_inout %9 : !hw.inout<i1>
        sv.verbatim "assert property (@(posedge CLK) {{0}} |-> ##3 {{1}});" (%6, %8) : i1, i1
        %11 = sv.xmr "delay", "inner_delay", "inner_inner_delay", "OUTPUT_0_valid" : !hw.inout<i1>
        %10 = sv.read_inout %11 : !hw.inout<i1>
        %13 = sv.xmr "delay", "inner_delay", "inner_inner_delay", "INPUT_1_ready" : !hw.inout<i1>
