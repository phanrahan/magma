module attributes {circt.loweringOptions = "locationInfoStyle=none,omitVersionComment"} {
    ...
    hw.module @Main(in %I_0_data: i5, in %I_0_valid: i1, in %I_1_data: i5, in %I_1_valid: i1, in %O_0_ready: i1, in %O_1_ready: i1, in %CLK: i1, out I_0_ready: i1, out I_1_ready: i1, out O_0_data: i5, out O_0_valid: i1, out O_1_data: i5, out O_1_valid: i1) {
