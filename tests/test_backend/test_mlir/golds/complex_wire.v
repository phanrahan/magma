...
module complex_wire(	// <stdin>:1:1
  ...
  wire [7:0]  tmp0 = I0;	// <stdin>:2:10
  wire        tmp1 = I1;	// <stdin>:5:10
  wire [31:0] tmp2 = {I2[2'h3], I2[2'h2], I2[2'h1], I2[2'h0]};	// <stdin>:8:10, :9:10, :18:11, :19:11, :28:11, :29:11, :38:11, :39:11, :48:11, :49:11
