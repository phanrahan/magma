...
module xmr_bind_asserts(	// <stdin>:8:1
  ...
  wire [15:0] _magma_inline_wire0 = other;	// <stdin>:9:10
...
module xmr_bind(	// <stdin>:14:1
  ...
  wire [15:0] _xmr_bind_asserts_inst_other;	// <stdin>:18:5
  wire [15:0] _xmr_bind_child_inst0_y;	// <stdin>:15:10
  xmr_bind_child xmr_bind_child_inst0 (	// <stdin>:15:10
    .a (a),
    .y (_xmr_bind_child_inst0_y)
  );
  assign _xmr_bind_asserts_inst_other = xmr_bind_child_inst0.xmr_bind_grandchild_inst0.y;	// <stdin>:16:10, :17:10, :18:5
  /* This instance is elsewhere emitted as a bind statement.
    xmr_bind_asserts xmr_bind_asserts_inst (	// <stdin>:18:5
      .a     (a),
      .y     (_xmr_bind_child_inst0_y),	// <stdin>:15:10
      .other (_xmr_bind_asserts_inst_other)	// <stdin>:18:5
    );
  */
  assign y = _xmr_bind_child_inst0_y;	// <stdin>:15:10, :19:5
endmodule
