module attributes {circt.loweringOptions = "locationInfoStyle=none,omitVersionComment"} {
    ...
    hw.module @xmr_bind_asserts(in %a: i16, in %y: i16, in %other: i16) {
    ...
    hw.module @xmr_bind(in %a: i16, out y: i16) {
        ...
        hw.instance "xmr_bind_asserts_inst" sym @xmr_bind.xmr_bind_asserts_inst @xmr_bind_asserts(a: %a: i16, y: %0: i16, other: %2: i16) -> () {doNotPrint = true}
        hw.output %0 : i16
    }
