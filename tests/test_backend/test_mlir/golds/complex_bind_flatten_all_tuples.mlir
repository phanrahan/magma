hw.module @complex_bind_child(%I_I: i1) -> (O_I: i1) {
    hw.output %I_I : i1
}
hw.module @complex_bind_asserts(%I_I: i1, %O: i1, %CLK: i1, %I0: i1, %I1: i1, %I2: i1) -> () {
...
hw.module @complex_bind(%I_I: i1, %CLK: i1) -> (O: i1) {
    ...
    %6 = hw.instance "complex_bind_child_inst0" @complex_bind_child(I_I: %I_I: i1) -> (O_I: i1)
    ...
    hw.instance "complex_bind_asserts_inst" sym @complex_bind.complex_bind_asserts_inst @complex_bind_asserts(I_I: %I_I: i1, O: %3: i1, CLK: %CLK: i1, I0: %0: i1, I1: %8: i1, I2: %10: i1) -> () {doNotPrint = 1}
    hw.output %3 : i1
}
