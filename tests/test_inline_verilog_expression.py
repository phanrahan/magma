...
EndCircuit()Wire = DeclareCircuit("Wire", "I", In(Bits[1]), "O", Out(Bits[1]))InlineVerilogExpression_Bits1_a489b4461c0192fc = DeclareCircuit("InlineVerilogExpression_Bits1_a489b4461c0192fc", "O", Out(Bits[1]))MyWrapperGen_1 = DefineCircuit("MyWrapperGen_1", "I", In(Bits[1]), "O", Out(Bits[1]), "CLK", In(Clock))
...
wire(_magma_inline_wire0.out, _MyWrapperGen_inline_verilog_inst_0.__magma_inline_value_0)
wire(MyWrapperGen_1.I, _magma_inline_wire0.in)
...
term_inst0 = term()
wire(_MyWrapperGen_inline_verilog_0.__magma_inline_value_0, term_inst0.in)
EndCircuit()Wire = DeclareCircuit("Wire", "I", In(Bits[2]), "O", Out(Bits[2]))InlineVerilogExpression_Bits2_a489b4461c0192fc = DeclareCircuit("InlineVerilogExpression_Bits2_a489b4461c0192fc", "O", Out(Bits[2]))MyWrapperGen_2 = DefineCircuit("MyWrapperGen_2", "I", In(Bits[2]), "O", Out(Bits[2]), "CLK", In(Clock))
InlineVerilogExpression_Bits2_a489b4461c0192fc_inst0 = InlineVerilogExpression_Bits2_a489b4461c0192fc()
_MyWrapperGen_inline_verilog_inst_0 = _MyWrapperGen_inline_verilog_0(name="_MyWrapperGen_inline_verilog_inst_0")
_magma_inline_wire0 = Wire(name="_magma_inline_wire0")
wire(_magma_inline_wire0.out, _MyWrapperGen_inline_verilog_inst_0.__magma_inline_value_0)
wire(MyWrapperGen_2.I, _magma_inline_wire0.in)
