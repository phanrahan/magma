module attributes {circt.loweringOptions = "locationInfoStyle=none,disallowLocalVariables"} {
    hw.module @test_when_tuple_as_bits_resolve(%I_x_y: i1, %I_x_z_x: i8, %I_x_z_y: i1, %I_x_x: !hw.array<2xi8>, %I_y: i8, %S: i1) -> (O_x_y: i1, O_x_z_x: i8, O_x_z_y: i1, O_x_x: !hw.array<2xi8>, O_y: i8, X: i34) {
        ...
        sv.verbatim "WHEN_ASSERT_366: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %10, %I_x_y) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_367: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %12, %5) : i1, i1, i1
        %102 = comb.extract %4 from 0 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_368: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %69, %102) : i1, i1, i1
        %103 = comb.extract %4 from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_369: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %70, %103) : i1, i1, i1
        %104 = comb.extract %4 from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_370: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %71, %104) : i1, i1, i1
        %105 = comb.extract %4 from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_371: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %72, %105) : i1, i1, i1
        %106 = comb.extract %4 from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_372: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %73, %106) : i1, i1, i1
        %107 = comb.extract %4 from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_373: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %74, %107) : i1, i1, i1
        %108 = comb.extract %4 from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_374: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %75, %108) : i1, i1, i1
        %109 = comb.extract %4 from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_375: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %76, %109) : i1, i1, i1
        %110 = comb.extract %0 from 0 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_376: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %77, %110) : i1, i1, i1
        %111 = comb.extract %0 from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_377: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %78, %111) : i1, i1, i1
        %112 = comb.extract %0 from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_378: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %79, %112) : i1, i1, i1
        %113 = comb.extract %0 from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_379: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %80, %113) : i1, i1, i1
        %114 = comb.extract %0 from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_380: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %81, %114) : i1, i1, i1
        %115 = comb.extract %0 from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_381: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %82, %115) : i1, i1, i1
        %116 = comb.extract %0 from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_382: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %83, %116) : i1, i1, i1
        %117 = comb.extract %0 from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_383: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %84, %117) : i1, i1, i1
        %118 = comb.extract %2 from 0 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_384: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %85, %118) : i1, i1, i1
        %119 = comb.extract %2 from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_385: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %86, %119) : i1, i1, i1
        %120 = comb.extract %2 from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_386: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %87, %120) : i1, i1, i1
        %121 = comb.extract %2 from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_387: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %88, %121) : i1, i1, i1
        %122 = comb.extract %2 from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_388: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %89, %122) : i1, i1, i1
        %123 = comb.extract %2 from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_389: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %90, %123) : i1, i1, i1
        %124 = comb.extract %2 from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_390: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %91, %124) : i1, i1, i1
        %125 = comb.extract %2 from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_391: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %92, %125) : i1, i1, i1
        %127 = hw.constant -1 : i1
        %126 = comb.xor %127, %S : i1
        sv.verbatim "WHEN_ASSERT_392: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %10, %I_x_y) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_393: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %12, %I_x_z_y) : i1, i1, i1
        %128 = comb.extract %I_x_z_x from 0 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_394: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %69, %128) : i1, i1, i1
        %129 = comb.extract %I_x_z_x from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_395: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %70, %129) : i1, i1, i1
        %130 = comb.extract %I_x_z_x from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_396: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %71, %130) : i1, i1, i1
        %131 = comb.extract %I_x_z_x from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_397: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %72, %131) : i1, i1, i1
        %132 = comb.extract %I_x_z_x from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_398: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %73, %132) : i1, i1, i1
        %133 = comb.extract %I_x_z_x from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_399: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %74, %133) : i1, i1, i1
        %134 = comb.extract %I_x_z_x from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_400: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %75, %134) : i1, i1, i1
        %135 = comb.extract %I_x_z_x from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_401: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %76, %135) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_402: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %77, %110) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_403: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %78, %111) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_404: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %79, %112) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_405: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %80, %113) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_406: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %81, %114) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_407: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %82, %115) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_408: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %83, %116) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_409: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %84, %117) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_410: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %85, %118) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_411: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %86, %119) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_412: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %87, %120) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_413: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %88, %121) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_414: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %89, %122) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_415: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %90, %123) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_416: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %91, %124) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_417: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %92, %125) : i1, i1, i1
        %136 = comb.extract %I_y from 0 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_418: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %93, %136) : i1, i1, i1
        %137 = comb.extract %I_y from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_419: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %94, %137) : i1, i1, i1
        %138 = comb.extract %I_y from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_420: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %95, %138) : i1, i1, i1
        %139 = comb.extract %I_y from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_421: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %96, %139) : i1, i1, i1
        %140 = comb.extract %I_y from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_422: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %97, %140) : i1, i1, i1
        %141 = comb.extract %I_y from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_423: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %98, %141) : i1, i1, i1
        %142 = comb.extract %I_y from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_424: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %99, %142) : i1, i1, i1
        %143 = comb.extract %I_y from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_425: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%126, %100, %143) : i1, i1, i1
        %144 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_426: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%144, %93, %136) : i1, i1, i1
        %145 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_427: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%145, %94, %137) : i1, i1, i1
        %146 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_428: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%146, %95, %138) : i1, i1, i1
        %147 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_429: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%147, %96, %139) : i1, i1, i1
        %148 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_430: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%148, %97, %140) : i1, i1, i1
        %149 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_431: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%149, %98, %141) : i1, i1, i1
        %150 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_432: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%150, %99, %142) : i1, i1, i1
        %151 = comb.xor %127, %126 : i1
        sv.verbatim "WHEN_ASSERT_433: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%151, %100, %143) : i1, i1, i1
