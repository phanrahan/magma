module attributes {circt.loweringOptions = "locationInfoStyle=none,omitVersionComment"} {
    hw.module @LogicAsserts(in %I: i1, in %O: i1, in %other: i1) attributes {output_filelist = #hw.output_filelist<"$cwd/build/test_bind_compile_guard_generator_bind_files.list">} {
    ...
    hw.module @LogicAsserts_unq1(in %I: i2, in %O: i2, in %other: i1) attributes {output_filelist = #hw.output_filelist<"$cwd/build/test_bind_compile_guard_generator_bind_files.list">} {
