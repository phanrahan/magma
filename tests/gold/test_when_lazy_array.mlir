module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_lazy_array(%S: i1) -> (O: i2) {
        ...
        %10 = sv.wire sym @test_when_lazy_array._WHEN_ASSERT_0 name "_WHEN_ASSERT_0" : !hw.inout<i1>
        sv.assign %10, %2 : i1
        %9 = sv.read_inout %10 : !hw.inout<i1>
        %11 = hw.constant 0 : i1
        sv.verbatim "WHEN_ASSERT_0: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %9, %11) : i1, i1, i1
        %13 = sv.wire sym @test_when_lazy_array._WHEN_ASSERT_1 name "_WHEN_ASSERT_1" : !hw.inout<i1>
        sv.assign %13, %3 : i1
