module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_lazy_array_slice_driving_resolve_2(%I: i4, %S: i1) -> (O: i4) {
        ...
        sv.verbatim "WHEN_ASSERT_99: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %11, %14) : i1, i1, i1
        %18 = comb.extract %I from 1 : (i4) -> i1
        sv.verbatim "WHEN_ASSERT_100: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %12, %18) : i1, i1, i1
        %19 = comb.extract %I from 2 : (i4) -> i1
        sv.verbatim "WHEN_ASSERT_101: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %13, %19) : i1, i1, i1
        %21 = hw.constant -1 : i1
        %20 = comb.xor %21, %S : i1
        %22 = hw.constant 0 : i1
        sv.verbatim "WHEN_ASSERT_102: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %11, %22) : i1, i1, i1
        %23 = hw.constant 0 : i1
        sv.verbatim "WHEN_ASSERT_103: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %12, %23) : i1, i1, i1
        %24 = hw.constant 1 : i1
        sv.verbatim "WHEN_ASSERT_104: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %13, %24) : i1, i1, i1
        hw.output %16 : i4
    }
}
