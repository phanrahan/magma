module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_3d_array_assign(%I: !hw.array<2x!hw.array<2xi2>>, %S: i1) -> (O: !hw.array<2x!hw.array<2xi2>>) {
        ...
        %18 = hw.array_get %0[%2] : !hw.array<2x!hw.array<2xi2>>, i1
        ...
        sv.verbatim "always @(*) WHEN_ASSERT_293: assert (~({{0}}) | ({{1}} == {{2}}));" (%S, %21, %20) : i1, i2, i2
        %22 = hw.array_get %I[%4] : !hw.array<2x!hw.array<2xi2>>, i1
        %23 = hw.array_get %22[%4] : !hw.array<2xi2>, i1
        %24 = hw.array_get %0[%4] : !hw.array<2x!hw.array<2xi2>>, i1
        %25 = hw.array_get %24[%4] : !hw.array<2xi2>, i1
        sv.verbatim "always @(*) WHEN_ASSERT_294: assert (~({{0}}) | ({{1}} == {{2}}));" (%S, %25, %23) : i1, i2, i2
        ...
        sv.verbatim "always @(*) WHEN_ASSERT_297: assert (~({{0}}) | ({{1}} == {{2}}));" (%28, %21, %23) : i1, i2, i2
