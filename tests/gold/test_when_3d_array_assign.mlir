module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_3d_array_assign(%I: !hw.array<2x!hw.array<2xi2>>, %S: i1) -> (O: !hw.array<2x!hw.array<2xi2>>) {
        ...
        sv.verbatim "WHEN_ASSERT_273: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %17, %19) : i1, i2, i2
        %20 = hw.array_get %16[%2] : !hw.array<2xi2>, i1
        %21 = hw.array_get %18[%2] : !hw.array<2xi2>, i1
        sv.verbatim "WHEN_ASSERT_274: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %20, %21) : i1, i2, i2
        ...
        sv.verbatim "WHEN_ASSERT_275: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %23, %25) : i1, i2, i2
        %26 = hw.array_get %22[%2] : !hw.array<2xi2>, i1
        %27 = hw.array_get %24[%2] : !hw.array<2xi2>, i1
        sv.verbatim "WHEN_ASSERT_276: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %26, %27) : i1, i2, i2
        %29 = hw.constant -1 : i1
        %28 = comb.xor %29, %S : i1
        sv.verbatim "WHEN_ASSERT_277: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %17, %27) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_278: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %20, %25) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_279: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %23, %21) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_280: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %26, %19) : i1, i2, i2
