module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_multiple_drivers(%I: i2, %S: i2) -> (O0: i1, O1: i1) {
        ...
        %8 = comb.and %0, %1 : i1
        sv.verbatim "WHEN_ASSERT_0: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%8, %4, %3) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_1: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%8, %5, %2) : i1, i1, i1
        %10 = hw.constant -1 : i1
        %9 = comb.xor %10, %8 : i1
        sv.verbatim "WHEN_ASSERT_2: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%9, %4, %2) : i1, i1, i1
        %11 = comb.xor %10, %8 : i1
        sv.verbatim "WHEN_ASSERT_3: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%11, %5, %3) : i1, i1, i1
        hw.output %4, %5 : i1, i1
    }
}
