module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    ...
    hw.module @test_when_memory_Tuplex_Bit_y_Bits7(%data0: !hw.struct<x: i1, y: i7>, %addr0: i5, %en0: i1, %data1: !hw.struct<x: i1, y: i7>, %addr1: i5, %en1: i1, %CLK: i1) -> (out: !hw.struct<x: i1, y: i7>) {
        %0 = hw.constant 1 : i1
