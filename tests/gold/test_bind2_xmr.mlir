hw.module @Bottom(%I: !hw.struct<x: i1, y: i1>) -> (O: !hw.struct<x: i1, y: i1>) {
    %1 = sv.wire sym @Bottom.bind_value_0 {name="bind_value_0"} : !hw.inout<!hw.struct<x: i1, y: i1>>
    sv.assign %1, %I : !hw.struct<x: i1, y: i1>
    %0 = sv.read_inout %1 : !hw.inout<!hw.struct<x: i1, y: i1>>
    %2 = hw.struct_extract %I["x"] : !hw.struct<x: i1, y: i1>
    %4 = sv.wire sym @Bottom.bind_value_1 {name="bind_value_1"} : !hw.inout<i1>
    sv.assign %4, %2 : i1
