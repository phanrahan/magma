module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    ...
    hw.module @test_when_user_reg_enable(%I: i8, %x: i2, %CLK: i1) -> (O: i8) {
        ...
        sv.verbatim "WHEN_ASSERT_179: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%0, %7, %I) : i1, i8, i8
        %11 = hw.constant 1 : i1
        sv.verbatim "WHEN_ASSERT_180: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%0, %8, %11) : i1, i1, i1
        %13 = hw.constant -1 : i1
        %12 = comb.xor %13, %0 : i1
        %14 = comb.and %12, %2 : i1
        sv.verbatim "WHEN_ASSERT_181: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%14, %7, %3) : i1, i8, i8
        %15 = hw.constant 1 : i1
        sv.verbatim "WHEN_ASSERT_182: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%14, %8, %15) : i1, i1, i1
        %16 = comb.or %0, %14 : i1
        %17 = comb.xor %13, %16 : i1
        sv.verbatim "WHEN_ASSERT_183: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%17, %7, %6) : i1, i8, i8
        %18 = comb.or %0, %14 : i1
        %19 = comb.xor %13, %18 : i1
        %20 = hw.constant 0 : i1
        sv.verbatim "WHEN_ASSERT_184: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%19, %8, %20) : i1, i1, i1
        hw.output %6 : i8
    }
}
