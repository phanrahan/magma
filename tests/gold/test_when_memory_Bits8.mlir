module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    ...
    hw.module @test_when_memory_Bits8(%data0: i8, %addr0: i5, %en0: i1, %data1: i8, %addr1: i5, %en1: i1, %CLK: i1) -> (out: i8) {
        ...
        sv.verbatim "WHEN_ASSERT_1: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%en0, %3, %data0) : i1, i8, i8
        %17 = hw.constant 1 : i1
        sv.verbatim "WHEN_ASSERT_2: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%en0, %4, %17) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_3: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%en0, %1, %addr1) : i1, i5, i5
        sv.verbatim "WHEN_ASSERT_4: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%en0, %11, %5) : i1, i8, i8
        %19 = hw.constant -1 : i1
        %18 = comb.xor %19, %en0 : i1
        %20 = comb.and %18, %en1 : i1
        sv.verbatim "WHEN_ASSERT_5: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %2, %addr1) : i1, i5, i5
        sv.verbatim "WHEN_ASSERT_6: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %3, %data1) : i1, i8, i8
        %21 = hw.constant 1 : i1
        sv.verbatim "WHEN_ASSERT_7: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %4, %21) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_8: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %1, %addr0) : i1, i5, i5
        sv.verbatim "WHEN_ASSERT_9: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%20, %11, %5) : i1, i8, i8
        %22 = comb.xor %19, %en1 : i1
        %23 = comb.and %18, %22 : i1
        %24 = hw.constant 255 : i8
        sv.verbatim "WHEN_ASSERT_10: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%23, %11, %24) : i1, i8, i8
        %25 = comb.or %en0, %20 : i1
        %26 = comb.xor %19, %25 : i1
        %27 = hw.constant 0 : i5
        sv.verbatim "WHEN_ASSERT_11: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%26, %2, %27) : i1, i5, i5
        %28 = comb.or %en0, %20 : i1
        %29 = comb.xor %19, %28 : i1
        %30 = hw.constant 0 : i8
        sv.verbatim "WHEN_ASSERT_12: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%29, %3, %30) : i1, i8, i8
        %31 = comb.or %en0, %20 : i1
        %32 = comb.xor %19, %31 : i1
        %33 = hw.constant 0 : i1
        sv.verbatim "WHEN_ASSERT_13: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%32, %4, %33) : i1, i1, i1
        %34 = comb.or %en0, %20 : i1
        %35 = comb.xor %19, %34 : i1
        %36 = hw.constant 0 : i5
        sv.verbatim "WHEN_ASSERT_14: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%35, %1, %36) : i1, i5, i5
        hw.output %11 : i8
    }
}
