module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_nested_array_assign(%I_x: i1, %I_y_0: i1, %I_y_1: i8, %S: i1) -> (O_x: i1, O_y_0: i1, O_y_1: i8) {
        ...
        sv.verbatim "WHEN_ASSERT_241: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %12, %13) : i1, i1, i1
        %14 = comb.extract %0 from 1 : (i8) -> i1
        %15 = comb.extract %I_y_1 from 1 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_242: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %14, %15) : i1, i1, i1
        %16 = comb.extract %0 from 2 : (i8) -> i1
        %17 = comb.extract %I_y_1 from 2 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_243: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %16, %17) : i1, i1, i1
        %18 = comb.extract %0 from 3 : (i8) -> i1
        %19 = comb.extract %I_y_1 from 3 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_244: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %18, %19) : i1, i1, i1
        %20 = comb.extract %0 from 4 : (i8) -> i1
        %21 = comb.extract %I_y_1 from 4 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_245: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %20, %21) : i1, i1, i1
        %22 = comb.extract %0 from 5 : (i8) -> i1
        %23 = comb.extract %I_y_1 from 5 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_246: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %22, %23) : i1, i1, i1
        %24 = comb.extract %0 from 6 : (i8) -> i1
        %25 = comb.extract %I_y_1 from 6 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_247: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %24, %25) : i1, i1, i1
        %26 = comb.extract %0 from 7 : (i8) -> i1
        %27 = comb.extract %I_y_1 from 7 : (i8) -> i1
        sv.verbatim "WHEN_ASSERT_248: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%S, %26, %27) : i1, i1, i1
        %29 = hw.constant -1 : i1
        %28 = comb.xor %29, %S : i1
        sv.verbatim "WHEN_ASSERT_249: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %12, %27) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_250: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %14, %25) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_251: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %16, %23) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_252: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %18, %21) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_253: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %20, %19) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_254: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %22, %17) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_255: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %24, %15) : i1, i1, i1
        sv.verbatim "WHEN_ASSERT_256: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %26, %13) : i1, i1, i1
