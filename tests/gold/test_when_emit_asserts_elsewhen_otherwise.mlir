module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_emit_asserts_elsewhen_otherwise(%I: i2, %S: i2) -> (O: i1) {
        ...
        sv.verbatim "WHEN_ASSERT_375: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%0, %6, %1) : i1, i1, i1
        %8 = comb.xor %4, %0 : i1
        %9 = comb.and %8, %2 : i1
        sv.verbatim "WHEN_ASSERT_376: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%9, %6, %3) : i1, i1, i1
        %10 = comb.xor %4, %2 : i1
        %11 = comb.and %8, %10 : i1
        sv.verbatim "WHEN_ASSERT_377: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%11, %6, %5) : i1, i1, i1
        hw.output %6 : i1
    }
}
