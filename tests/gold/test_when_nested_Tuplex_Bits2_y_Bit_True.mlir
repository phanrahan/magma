module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_nested_Tuplex_Bits2_y_Bit_True(%I_0_x: i2, %I_0_y: i1, %I_1_x: i2, %I_1_y: i1, %S: i1) -> (O_x: i2, O_y: i1) {
        ...
        %5 = sv.wire sym @test_when_nested_Tuplex_Bits2_y_Bit_True._WHEN_ASSERT_0 name "_WHEN_ASSERT_0" : !hw.inout<i2>
        sv.assign %5, %0 : i2
        %4 = sv.read_inout %5 : !hw.inout<i2>
        %7 = sv.wire sym @test_when_nested_Tuplex_Bits2_y_Bit_True._WHEN_ASSERT_1 name "_WHEN_ASSERT_1" : !hw.inout<i1>
        sv.assign %7, %1 : i1
