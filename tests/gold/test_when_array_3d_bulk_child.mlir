module attributes {circt.loweringOptions = "locationInfoStyle=none"} {
    hw.module @test_when_array_3d_bulk_child(%I: !hw.array<2x!hw.array<2xi2>>, %S: i1) -> (O: !hw.array<2x!hw.array<2xi2>>) {
        ...
        sv.verbatim "WHEN_ASSERT_297: assert property (({{0}}) |-> ({{{1}}, {{2}}} == {{{3}}, {{4}}}));" (%S, %17, %18, %20, %21) : i1, i2, i2, i2, i2
        ...
        sv.verbatim "WHEN_ASSERT_298: assert property (({{0}}) |-> ({{{1}}, {{2}}} == {{{3}}, {{4}}}));" (%S, %23, %24, %26, %27) : i1, i2, i2, i2, i2
        %29 = hw.constant -1 : i1
        %28 = comb.xor %29, %S : i1
        sv.verbatim "WHEN_ASSERT_299: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %18, %27) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_300: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %17, %26) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_301: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %24, %21) : i1, i2, i2
        sv.verbatim "WHEN_ASSERT_302: assert property (({{0}}) |-> ({{1}} == {{2}}));" (%28, %23, %20) : i1, i2, i2
