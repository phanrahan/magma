...
hw.module @test_when_memory_TupleBit_Bits7(%data0__0: i1, %data0__1: i7, %addr0: i5, %en0: i1, %data1__0: i1, %data1__1: i7, %addr1: i5, %en1: i1, %CLK: i1) -> (out__0: i1, out__1: i7) {
    ...
    %8 = hw.constant 1 : i1
    %9 = hw.constant 127 : i7
    %12 = sv.reg {name = "WADDR_reg"} : !hw.inout<i5>
    %13 = sv.reg {name = "Memory_inst0.WDATA[0]_reg"} : !hw.inout<i1>
    %14 = sv.reg {name = "Memory_inst0.WDATA[1]_reg"} : !hw.inout<i7>
    %15 = sv.reg {name = "WE_reg"} : !hw.inout<i1>
    %16 = sv.reg {name = "RADDR_reg"} : !hw.inout<i5>
    %17 = sv.reg {name = "test_when_memory_TupleBit_Bits7.out[0]_reg"} : !hw.inout<i1>
    %18 = sv.reg {name = "test_when_memory_TupleBit_Bits7.out[1]_reg"} : !hw.inout<i7>
    sv.alwayscomb {
        %19 = hw.constant 0 : i5
        sv.bpassign %12, %19 : i5
        %20 = hw.constant 0 : i1
        sv.bpassign %13, %20 : i1
        %21 = hw.constant 0 : i7
        sv.bpassign %14, %21 : i7
        %22 = hw.constant 0 : i1
        sv.bpassign %15, %22 : i1
        sv.bpassign %16, %19 : i5
        sv.if %en0 {
            sv.bpassign %12, %addr0 : i5
            sv.bpassign %13, %data0__0 : i1
            sv.bpassign %14, %data0__1 : i7
            sv.bpassign %15, %8 : i1
            ...
            sv.if %en1 {
                ...
                sv.bpassign %13, %data1__0 : i1
                sv.bpassign %14, %data1__1 : i7
                sv.bpassign %15, %8 : i1
    ...
    %3 = sv.read_inout %13 : !hw.inout<i1>
    %4 = sv.read_inout %14 : !hw.inout<i7>
    %5 = sv.read_inout %15 : !hw.inout<i1>
    %1 = sv.read_inout %16 : !hw.inout<i5>
    %10 = sv.read_inout %17 : !hw.inout<i1>
    %11 = sv.read_inout %18 : !hw.inout<i7>
    hw.output %10, %11 : i1, i7
}
