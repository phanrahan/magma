hw.module @test_when_nested_Array2_TupleBit_Bits2_Bit(%I_0_0__0: i1, %I_0_0__1: i2, %I_0_1__0: i1, %I_0_1__1: i2, %I_1_0__0: i1, %I_1_0__1: i2, %I_1_1__0: i1, %I_1_1__1: i2, %S: i1) -> (O_0__0: i1, O_0__1: i2, O_1__0: i1, O_1__1: i2) {
    %4 = sv.reg {name = "test_when_nested_Array2_TupleBit_Bits2_Bit.O[0][0]_reg"} : !hw.inout<i1>
    %5 = sv.reg {name = "test_when_nested_Array2_TupleBit_Bits2_Bit.O[0][1]_reg"} : !hw.inout<i2>
    %6 = sv.reg {name = "test_when_nested_Array2_TupleBit_Bits2_Bit.O[1][0]_reg"} : !hw.inout<i1>
    %7 = sv.reg {name = "test_when_nested_Array2_TupleBit_Bits2_Bit.O[1][1]_reg"} : !hw.inout<i2>
    sv.alwayscomb {
