hw.module @Foo(%I0_tag: i1, %I0_data: i2, %I1: i2) -> (O0_tag: i1, O0_data: i2, O1: i2, O2_tag: i1, O2_data: i2) {
    ...
    %33 = sv.reg {name = "Foo.O0.tag_reg"} : !hw.inout<i1>
    %34 = sv.reg {name = "Foo.O0.data[0]_reg"} : !hw.inout<i1>
    %35 = sv.reg {name = "Foo.O0.data[1]_reg"} : !hw.inout<i1>
    %36 = sv.reg {name = "Foo.O1[0]_reg"} : !hw.inout<i1>
    %37 = sv.reg {name = "Foo.O1[1]_reg"} : !hw.inout<i1>
    %38 = sv.reg {name = "Foo.O2.tag_reg"} : !hw.inout<i1>
    %39 = sv.reg {name = "Foo.O2.data[0]_reg"} : !hw.inout<i1>
    %40 = sv.reg {name = "Foo.O2.data[1]_reg"} : !hw.inout<i1>
    sv.alwayscomb {
        sv.if %1 {
            sv.bpassign %33, %2 : i1
            sv.bpassign %34, %4 : i1
