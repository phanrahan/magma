...
def test_array2_wire_to_index():
    ...
    m.compile("build/test_array2_wire_to_index", Foo)
    assert check_files_equal(__file__, "build/test_array2_wire_to_index.v",
                             "gold/test_array2_wire_to_index.v")
