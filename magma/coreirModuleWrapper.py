...
def ModuleFromGeneratorWrapper(cirb: CoreIRBackend, namespace: str, generator: str, genargs):
    return DefineModuleWrapper(cirb, cirb.context.import_generator(namespace,
                                                                   generator)(**genargs))()