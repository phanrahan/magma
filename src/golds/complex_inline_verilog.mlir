hw.module @complex_inline_verilog_inline_verilog_0(%__magma_inline_value_0: i1, %__magma_inline_value_1: i1) -> () {
    sv.verbatim "assert property (@(posedge CLK) {{1}} |-> ##1 {{0}});" (%__magma_inline_value_0, %__magma_inline_value_1) : i1, i1
}
hw.module @complex_inline_verilog(%I: i1, %CLK: i1) -> (%O: i1) {
    ...
    hw.instance "complex_inline_verilog_inline_verilog_inst_0" @complex_inline_verilog_inline_verilog_0(%3, %5) : (i1, i1) -> ()
    hw.output %0 : i1
}
